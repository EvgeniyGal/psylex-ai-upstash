# Mode B Mediator Session End Redirect

## Purpose

When a Mode B session reaches an outcome, the mediator is taken to room details instead of remaining on an idle live console, even if scheduled session time remains.
